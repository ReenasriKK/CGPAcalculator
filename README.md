...
✏️ Grade points and credit values are entered per subject.
...
🖥️ Simple terminal-based application with clear prompts.
🧑‍💻 No complex setup — just compile and run!

✅ 4. Lightweight & Portable
⚙️ No external libraries or tools required.
...
🛠️ Can be extended to GUI, file export, or web app versions later.
